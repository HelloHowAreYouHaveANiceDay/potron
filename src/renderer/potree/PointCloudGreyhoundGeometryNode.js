...
export default class PointCloudGreyhoundGeometryNode extends PointCloudTreeNode {
  /* eslint-disable */
  ...
  loadHierarchyThenPoints() {
    ...
    const makeBitMask = function (node) {
      let mask = 0;
    ...
    const parseChildrenCounts = function (base, parentName, stack) {
    ...
    // Load hierarchy.
    const callback = function (node, greyhoundHierarchy) {
      const decoded = [];
