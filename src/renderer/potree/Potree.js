...
export const pointBudget = 1 * 1000 * 1000;
export const framenumber = 0;
export const numNodesLoading = 0;
export const maxNodesLoading = 4;

export const debug = {};

let scriptPath = ''; // eslint-disable-line
...
const resourcePath = `${scriptPath}/resources`;
...
export function loadPointCloud(path, name, callback) {
  ...
  if (!path) {
    ...
    // We check if the path string starts with 'greyhound:',
    // if so we assume it's a greyhound server URL.
